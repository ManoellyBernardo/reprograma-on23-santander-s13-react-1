  ...
  return(
    <section>
      <div>
        ...
        <Image img={'https://www.oficinadanet.com.br/media/post/15974/750/gif_1.gif'} alt='Aqui está um GIF que ilustra um experimento científico, especificamente um experimento de física'/>
      </div>
      <div>
        ...
        <Image img={'https://media4.giphy.com/media/y0NFayaBeiWEU/giphy.gif?cid=ecf05e475v8pbrzft8rp285g9hjces2bftapt54cglsa0wcf&ep=v1_gifs_search&rid=giphy.gif&ct=g'} alt='Aqui está um GIF do personagem Timmy Turner jogando e com os olhos vermelhos de tanto jogar'/>
      </div>
      <div>
        ...
        <Image img={'https://3.bp.blogspot.com/-e1WqWaVAA50/UK6ZiInrvII/AAAAAAAADEs/44wXDyLfUGQ/s1600/gato-lendo-livroa.gif'} alt='Aqui está um GIF de um gatinho lendo um livro'/>
      </div>
      <div>
        ...
        <Image img={'https://i0.wp.com/designculture.com.br/wp-content/uploads/2018/07/maratona.gif?resize=500%2C270&ssl=1'} alt='Aqui está um GIF de uma personagem da série Friends dizendo "Oh meu Deus, eu preciso de ajuda" depois de ter passado horas assistindo a uma série.'/>
      </div>
      <div>
        ...
        <Image img={'https://thumbs.gfycat.com/WealthyBelovedGreatdane-max-1mb.gif'} alt='Aqui está um GIF do personagem Luffy, de One Piece, dando um grande sorriso'/>
      </div>
    </section>
  )
}
